"""Gateway session create/patch service behavior."""
...
async def create_session(params: dict | None, ctx: RpcContext) -> dict:
...
async def patch_session(params: dict | None, ctx: RpcContext) -> dict:
